            ...
            <div className="bg-[#0C1322] border border-white/[0.09] rounded-2xl shadow-2xl shadow-black/70 overflow-hidden">
              ...
              <div className="px-7 py-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3 mb-5 bg-white/[0.04] hover:bg-white/[0.08] active:scale-[.98] border border-white/10 hover:border-white/20 text-white font-bold rounded-xl text-sm transition-all"
                >
                  {/* Google G icon */}
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[10px] font-bold text-gray-700 uppercase tracking-widest">ou</span>
                  <div className="flex-1 h-px bg-white/[0.07]" />
                </div>
